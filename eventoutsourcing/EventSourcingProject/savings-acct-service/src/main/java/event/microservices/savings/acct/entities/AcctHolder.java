...
public class AcctHolder implements Serializable {
    ...
    @OneToMany(mappedBy = "acctholderId")
    private Collection<SavingsAcct> savingsAcctCollection;
    ...
    @XmlTransient
    public Collection<SavingsAcct> getSavingsAcctCollection() {
        return savingsAcctCollection;
    }

    public void setSavingsAcctCollection(Collection<SavingsAcct> savingsAcctCollection) {
        this.savingsAcctCollection = savingsAcctCollection;
    }
    ...
    public String toString() {
        return "event.microservices.savings.acct.entities.AcctHolder[ id=" + id + " ]";
    }
